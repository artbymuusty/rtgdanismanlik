...
export const en: Dictionary = {
  ...
  home: {
    ...
    universityExplorer: {
      ...
      description: "Browse German universities ranked worldwide by the QS World University Rankings 2027.",
      rankingSourceLabel: "QS World University Rankings 2027",
      rankLabel: "World Ranking",
      prevAriaLabel: "Previous university",
      nextAriaLabel: "Next university",
      exploreCta: "Explore the university",
      indexButtonLabel: "Explore all 28 universities",
      indexTitle: "Universities",
      indexSearchPlaceholder: "Search universities...",
  ...
  contact: {
    ...
    composer: {
      ...
      messagePlaceholders: {
        ...
        billing: "How can we help?",
        complaint: "Describe what happened, which service it involves, and the date/time if possible.",
        technical: "Describe the error you encountered, which page it was on, and the error message if possible.",
        website: "Describe which page the issue is on and what you were doing when it happened.",
      ...
      successBody: "We've received your message. If needed, we'll get in touch using the e-mail address you provided.",
      errorTitle: "The message couldn't be sent.",
      errorBody: "Please try again or use a different contact channel.",
      retry: "Try again",
    },
  },
  bizeKatilin: {
